...
const LATEX_GUIDE_SECTIONS = [
  {
    title: "Basics",
    description:
      "Start here for plain equations, grouping, and the commands you'll use constantly.",
    items: [
  ...
  },
  {
    title: "Powers",
    description:
      "Use `^` for superscripts and `_` for subscripts. Wrap longer parts in braces.",
    items: [
  ...
  },
  {
    title: "Fractions",
    description:
      "Fractions and roots are some of the most common LaTeX structures for math formatting.",
    items: [
  ...
  },
  {
    title: "Calculus",
    description:
      "These patterns cover limits, sums, products, and integrals with lower and upper bounds.",
    items: [
  ...
  },
  {
    title: "Brackets",
    description:
      "Use `\\left` and `\\right` when you want brackets to grow with the content.",
    items: [
      ...
      { label: "Set braces", code: "\\left\\{ x \\in \\mathbb{R} \\right\\}" },
      {
        ...
        code: "\\begin{cases} x & x>0 \\\\ 0 & x=0 \\end{cases}",
      },
    ],
  },
  {
    title: "Matrices",
    description:
      "Matrices use `&` to separate columns and `\\\\` to start a new row.",
    items: [
      {
      ...
      {
        label: "Column vector",
        code: "\\begin{bmatrix} x \\\\ y \\\\ z \\end{bmatrix}",
      },
    ],
  },
  {
    title: "Symbols",
    description:
      "LaTeX gives you commands for Greek letters, operators, relations, arrows, and more.",
    items: [
  ...
  },
  {
    title: "Text",
    description:
      "Use text and spacing commands when you need words, labels, or cleaner visual rhythm.",
    items: [
  ...
  },
  {
    title: "Color",
    description:
      "This plugin supports a base equation color plus RGB color blocks for specific parts.",
    items: [
      { label: "Base color", code: "Use the color controls for the whole equation." },
      {
        label: "Color part",
        code: "{\\color[RGB]{255,0,0}x} + {\\color[RGB]{0,180,255}y}",
      },
      {
        label: "Mixed expression",
        code: "{\\color[RGB]{255,180,0}\\int} {\\color[RGB]{255,255,255}x^2} \\, dx",
      },
      {
        label: "Wrap selection tool",
        code: "Select part of the equation, then click Wrap Selection.",
      },
    ],
  },
];
...
`;
const CSS = `/*css*/@keyframes latex-generator-fade-up{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}@keyframes latex-generator-soft-glow{0%,100%{box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--background-modifier-accent)70%,transparent),0 14px 28px rgba(0,0,0,0.12)}50%{box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--bd-brand)28%,transparent),0 18px 34px rgba(0,0,0,0.16)}}.latex-generator-modal{display:flex;flex-direction:column;justify-content:flex-start;gap:12px;padding-top:2px;width:100%;height:100%;overflow:hidden;min-width:0;min-height:0;box-sizing:border-box;align-self:stretch;animation:latex-generator-fade-up 180ms ease-out}.latex-generator-shell-panel{display:flex;flex-direction:column;gap:14px;width:min(100%,1320px);margin:0 auto;flex:1 1 auto;min-height:0}.latex-generator-panel-divider{height:1px;background:color-mix(in srgb,var(--background-modifier-accent)70%,transparent);border-radius:999px}.latex-generator-top-grid{display:grid;grid-template-columns:minmax(0,1.02fr)minmax(420px,0.98fr);gap:18px;align-items:stretch}.latex-generator-shell{width:min(1360px,98vw)!important;max-width:98vw !important;min-height:min(1020px,98vh)!important;height:min(1020px,98vh)!important}.latex-generator-shell-content{max-height:98vh !important}.latex-generator-surface{background:linear-gradient(180deg,color-mix(in srgb,var(--background-secondary)92%,white 8%),var(--background-secondary));border:1px solid color-mix(in srgb,var(--background-modifier-accent)75%,transparent);border-radius:16px;box-shadow:0 10px 22px rgba(0,0,0,0.14);width:100%;min-width:0;transition:transform 160ms ease,box-shadow 160ms ease,border-color 160ms ease}.latex-generator-surface:hover{transform:none;border-color:color-mix(in srgb,var(--bd-brand)24%,var(--background-modifier-accent));box-shadow:0 12px 24px rgba(0,0,0,0.16)}.latex-generator-section-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 16px 0}.latex-generator-label-stack{display:flex;flex-direction:column;gap:4px}.latex-generator-section-title{color:var(--header-primary);font-size:15px;font-weight:700;letter-spacing:0.02em}.latex-generator-section-note{color:var(--text-muted);font-size:12px;line-height:1.45}.latex-generator-chip{display:inline-flex;align-items:center;gap:6px;padding:6px 10px;border-radius:999px;background:color-mix(in srgb,var(--background-tertiary)88%,transparent);border:1px solid color-mix(in srgb,var(--background-modifier-accent)75%,transparent);color:var(--text-normal);font-size:12px;white-space:nowrap;transition:transform 140ms ease,border-color 140ms ease,background 140ms ease}.latex-generator-chip:hover{transform:translateY(-1px);border-color:color-mix(in srgb,var(--bd-brand)30%,transparent);background:color-mix(in srgb,var(--background-tertiary)78%,white 22%)}.latex-generator-preview{display:flex;position:relative;min-height:clamp(280px,38vh,460px);max-height:none;margin:6px 8px 8px;overflow:hidden;border:1px solid color-mix(in srgb,var(--background-modifier-accent)80%,transparent);border-radius:14px;background:radial-gradient(circle at top,color-mix(in srgb,var(--brand-500)14%,transparent),transparent 55%),linear-gradient(180deg,color-mix(in srgb,var(--background-primary)72%,transparent),var(--background-tertiary));transition:border-color 180ms ease,box-shadow 180ms ease,transform 180ms ease}.latex-generator-preview:hover{transform:translateY(-1px);border-color:color-mix(in srgb,var(--bd-brand)26%,var(--background-modifier-accent));box-shadow:0 14px 30px rgba(0,0,0,0.16)}.latex-generator-preview-parent{position:relative;overflow-y:hidden;overflow-x:auto;display:flex;align-items:center;justify-content:center;width:100%;scrollbar-width:thin}.latex-generator-preview-container{display:flex;align-items:center;justify-content:center;gap:16px;padding:8px 0;min-width:100%;width:100%}.latex-generator-preview-container::before,.latex-generator-preview-container::after{content:"";display:block;flex-shrink:0;width:16px;height:1px}.latex-generator-preview-container>*{flex-shrink:0;margin:0 auto}.latex-generator-preview-wrapper{display:inline-flex;align-items:center;justify-content:center;line-height:0;padding:10px 12px;border-radius:12px;max-width:100%;max-height:100%;overflow:auto;background:color-mix(in srgb,var(--background-floating)72%,transparent);box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--background-modifier-accent)70%,transparent),0 14px 28px rgba(0,0,0,0.12);animation:latex-generator-soft-glow 3.8s ease-in-out infinite;transition:transform 180ms ease}.latex-generator-preview-wrapper:hover{transform:scale(1.01)}.latex-generator-preview-img{display:block;max-width:min(100%,760px);max-height:min(100%,420px);width:auto;height:auto;object-fit:contain}.latex-generator-preview-empty{display:block;padding:18px 20px;color:var(--text-muted);text-align:center;font-size:13px;line-height:1.5}.latex-generator-preview-overlay{position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,0.04),rgba(0,0,0,0.32));display:flex;align-items:center;justify-content:center;opacity:0;transition:opacity 0.2s ease-in-out;pointer-events:none;z-index:10;border-radius:14px}.latex-generator-preview:hover .latex-generator-preview-overlay{opacity:1}.latex-generator-preview-btn-wrapper{pointer-events:auto}.latex-generator-preview-btn{background:linear-gradient(135deg,var(--bd-brand),color-mix(in srgb,var(--bd-brand)82%,white 18%));color:#fff;border:1px solid color-mix(in srgb,var(--bd-brand-active)70%,transparent);border-radius:999px;padding:10px 22px;font-size:14px;font-weight:700;letter-spacing:0.02em;cursor:pointer;box-shadow:0 10px 24px color-mix(in srgb,var(--bd-brand)32%,transparent);transition:transform 0.2s ease,box-shadow 0.2s ease,opacity 0.2s}.latex-generator-preview-btn:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 14px 28px color-mix(in srgb,var(--bd-brand)40%,transparent)}.latex-generator-preview-btn:active:not(:disabled){transform:translateY(0)}.latex-generator-preview-btn:disabled{background:var(--input-border-default);color:var(--text-muted);border-color:transparent;box-shadow:none;cursor:not-allowed}.latex-generator-controls{display:flex;flex-direction:column;gap:8px;padding:10px}.latex-generator-meta-row{display:flex;align-items:flex-start;justify-content:space-between;gap:8px}.latex-generator-mobile-note{color:var(--text-muted);font-size:12px}.latex-generator-textarea{background:linear-gradient(180deg,color-mix(in srgb,var(--input-background-default)90%,white 10%),var(--input-background-default));color:var(--text-default);border:1px solid var(--input-border-default);border-radius:12px;padding:12px 14px;font-family:Consolas,"Liberation Mono",Menlo,monospace;font-size:13px;line-height:1.6;min-height:245px;width:100%;resize:vertical;outline:none;box-sizing:border-box;tab-size:2;box-shadow:inset 0 1px 0 rgba(255,255,255,0.04);transition:border-color 150ms linear,box-shadow 150ms linear,transform 150ms ease}.latex-generator-textarea:focus{border-color:var(--bd-brand-active);box-shadow:0 0 0 3px color-mix(in srgb,var(--bd-brand)20%,transparent);transform:translateY(-1px)}.latex-generator-textarea:hover:not(:focus){border-color:var(--bd-brand-hover)}.latex-generator-textarea::placeholder{color:var(--text-muted)}.latex-generator-toolbar{display:flex;flex-wrap:wrap;gap:6px}.latex-generator-snippets,.latex-generator-symbols{display:grid;gap:6px}.latex-generator-snippets{grid-template-columns:repeat(5,minmax(0,1fr))}.latex-generator-symbols{grid-template-columns:repeat(6,minmax(0,1fr))}.latex-generator-snippet-btn,.latex-generator-action-btn,.latex-generator-symbol-btn,.latex-generator-recent-btn,.latex-generator-swatch-btn{border:1px solid color-mix(in srgb,var(--background-modifier-accent)92%,white 8%);background:linear-gradient(180deg,color-mix(in srgb,var(--background-secondary)82%,white 18%),color-mix(in srgb,var(--background-secondary)96%,black 4%));color:var(--header-primary);border-radius:10px;padding:6px 10px;font-size:12px;font-weight:700;cursor:pointer;box-shadow:inset 0 1px 0 rgba(255,255,255,0.06),0 2px 8px rgba(0,0,0,0.14);transition:transform 0.15s ease,border-color 0.15s ease,background 0.15s ease,box-shadow 0.15s ease}.latex-generator-snippet-btn:hover,.latex-generator-action-btn:hover,.latex-generator-symbol-btn:hover,.latex-generator-recent-btn:hover,.latex-generator-swatch-btn:hover{transform:translateY(-1px);border-color:color-mix(in srgb,var(--bd-brand)58%,transparent);background:linear-gradient(180deg,color-mix(in srgb,var(--background-tertiary)78%,white 22%),color-mix(in srgb,var(--background-secondary)90%,black 10%));box-shadow:inset 0 1px 0 rgba(255,255,255,0.08),0 8px 18px rgba(0,0,0,0.16)}.latex-generator-snippet-btn:active,.latex-generator-action-btn:active,.latex-generator-symbol-btn:active,.latex-generator-recent-btn:active,.latex-generator-swatch-btn:active{transform:translateY(0);box-shadow:inset 0 1px 2px rgba(0,0,0,0.18),0 2px 6px rgba(0,0,0,0.1)}.latex-generator-grid{display:grid;grid-template-columns:minmax(0,1fr);gap:8px;align-items:start}.latex-generator-builder-grid{display:grid;grid-template-columns:minmax(0,1.28fr)minmax(190px,0.72fr);gap:8px;align-items:start}.latex-generator-builder-header{display:flex;align-items:center;justify-content:flex-start;gap:6px}.latex-generator-builder-main{display:grid;grid-template-columns:minmax(0,1fr);gap:6px}.latex-generator-guide-btn{width:auto;min-width:108px;flex:0 0 auto}.latex-generator-builder-mode-row{display:flex;align-items:center;justify-content:flex-start;gap:6px;min-width:0}.latex-generator-mode-select-wrap{flex:1 1 180px;min-width:0;max-width:220px}.latex-generator-inline-select-label{color:var(--text-muted);font-size:12px;font-weight:700;letter-spacing:0.04em;text-transform:uppercase;white-space:nowrap}.latex-generator-side-panel{display:flex;flex-direction:column;gap:6px;min-width:0}.latex-generator-panel{border:1px solid color-mix(in srgb,var(--background-modifier-accent)70%,transparent);background:color-mix(in srgb,var(--background-tertiary)88%,transparent);border-radius:12px;padding:9px;transition:border-color 160ms ease,transform 160ms ease,box-shadow 160ms ease}.latex-generator-panel:hover{transform:translateY(-1px);border-color:color-mix(in srgb,var(--bd-brand)24%,var(--background-modifier-accent));box-shadow:0 10px 20px rgba(0,0,0,0.1)}.latex-generator-panel-title{margin:0 0 6px;color:var(--header-secondary);font-size:13px;font-weight:700;letter-spacing:0.06em;text-transform:uppercase}.latex-generator-toolbar{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.latex-generator-action-btn{width:100%;text-align:center;justify-content:center}.latex-generator-snippet-btn,.latex-generator-symbol-btn{width:100%;text-align:center;justify-content:center}.latex-generator-action-btn{background:linear-gradient(180deg,color-mix(in srgb,var(--bd-brand)14%,var(--background-secondary)),color-mix(in srgb,var(--background-secondary)92%,black 8%))}.latex-generator-action-btn:hover{border-color:color-mix(in srgb,var(--bd-brand)68%,transparent)}.latex-generator-recent-btn{border-style:dashed}.latex-generator-inline-section{display:flex;align-items:center;justify-content:space-between;gap:12px;width:100%;min-height:60px;min-width:0}.latex-generator-inline-section .bd-slider-wrap{flex:1 1 auto;width:auto;max-width:none;min-width:0;padding:0;margin-top:0;margin-bottom:0}.latex-generator-inline-section .bd-slider-marker-container{transform:translateY(10px);min-width:0}.latex-generator-inline-section h1{min-width:42px;flex:0 0 auto;margin:0;color:var(--header-secondary);font-size:13px;font-weight:700;letter-spacing:0.04em;text-transform:uppercase}.latex-generator-size-section{margin-top:-4px}.latex-generator-rgb-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.latex-generator-field{display:flex;flex-direction:column;gap:4px}.latex-generator-field label{color:var(--text-muted);font-size:12px;font-weight:700;letter-spacing:0.05em;text-transform:uppercase}.latex-generator-number,.latex-generator-color-input,.latex-generator-select{width:100%;min-height:34px;border-radius:10px;border:1px solid var(--input-border-default);background:var(--input-background-default);color:var(--text-normal);box-sizing:border-box}.latex-generator-number{padding:0 10px}.latex-generator-color-input{padding:4px}.latex-generator-select{padding:0 10px;font-size:12px;font-weight:700;min-width:0}.latex-generator-select option{color:#000;background:#fff}.latex-generator-help{color:var(--text-muted);font-size:12px;line-height:1.4;margin-top:0}.latex-generator-top-tip{margin-top:-2px;padding:4px 7px;border:1px solid color-mix(in srgb,var(--bd-brand)22%,transparent);border-radius:12px;background:color-mix(in srgb,var(--bd-brand)10%,var(--background-tertiary));color:var(--text-normal);font-size:11px;line-height:1.3}.latex-generator-top-tip br{display:none}.latex-generator-top-tip strong{color:var(--header-primary)}.latex-generator-hex-input{width:100%;min-height:34px;border-radius:10px;border:1px solid var(--input-border-default);background:var(--input-background-default);color:var(--text-normal);box-sizing:border-box;padding:0 10px;font-family:Consolas,"Liberation Mono",Menlo,monospace}.latex-generator-swatch-grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:4px}.latex-generator-swatch-btn{min-height:24px;padding:0;overflow:hidden;border-radius:8px}.latex-generator-swatch-chip{display:block;width:100%;height:100%}.latex-generator-recent-list{display:flex;flex-direction:column;gap:6px}.latex-generator-recent-item{display:grid;grid-template-columns:minmax(0,1fr)auto;gap:6px;align-items:stretch}.latex-generator-recent-btn{text-align:left;justify-content:flex-start;font-family:Consolas,"Liberation Mono",Menlo,monospace;font-size:11px;line-height:1.4}.latex-generator-delete-btn{min-width:64px;padding:8px 10px}.latex-generator-guide{display:flex;flex-direction:column;gap:14px;max-height:62vh;overflow:auto;padding-right:6px}.latex-generator-guide-tabs{display:flex;flex-wrap:wrap;gap:8px}.latex-generator-guide-tab{border:1px solid color-mix(in srgb,var(--background-modifier-accent)82%,white 8%);background:linear-gradient(180deg,color-mix(in srgb,var(--background-secondary)82%,white 18%),color-mix(in srgb,var(--background-secondary)96%,black 4%));color:var(--header-primary);border-radius:10px;padding:8px 12px;font-size:12px;font-weight:700;cursor:pointer}.latex-generator-guide-tab.is-active{background:linear-gradient(180deg,color-mix(in srgb,var(--bd-brand)34%,white 8%),color-mix(in srgb,var(--bd-brand)24%,var(--background-secondary)));border-color:color-mix(in srgb,var(--bd-brand)78%,transparent);color:#fff}.latex-generator-guide-intro{color:var(--text-muted);font-size:12px;line-height:1.6}.latex-generator-guide-section{border:1px solid color-mix(in srgb,var(--background-modifier-accent)72%,transparent);background:color-mix(in srgb,var(--background-tertiary)88%,transparent);border-radius:12px;padding:12px}.latex-generator-guide-title{margin:0 0 10px;color:var(--header-primary);font-size:14px;font-weight:700}.latex-generator-guide-list{display:flex;flex-direction:column;gap:8px}.latex-generator-guide-row{display:grid;grid-template-columns:150px minmax(0,1fr);gap:10px;align-items:start}.latex-generator-guide-label{color:var(--text-muted);font-size:12px;font-weight:700}.latex-generator-guide-code{display:block;border-radius:10px;border:1px solid var(--input-border-default);background:var(--input-background-default);color:var(--header-primary);padding:8px 10px;font-family:Consolas,"Liberation Mono",Menlo,monospace;font-size:12px;line-height:1.5;white-space:pre-wrap;word-break:break-word}@media(prefers-reduced-motion:reduce){.latex-generator-modal,.latex-generator-surface,.latex-generator-chip,.latex-generator-preview,.latex-generator-preview-wrapper,.latex-generator-textarea,.latex-generator-snippet-btn,.latex-generator-action-btn,.latex-generator-symbol-btn,.latex-generator-recent-btn,.latex-generator-swatch-btn,.latex-generator-panel{animation:none !important;transition:none !important;transform:none !important}}.latex-generator-terms-container{display:flex;flex-direction:column;gap:15px;color:var(--text-default)}.latex-generator-terms-container p{margin:0;padding:0}.latex-generator-terms-link{color:var(--text-link)}@media(max-width:720px){.latex-generator-top-grid,.latex-generator-builder-header,.latex-generator-builder-grid,.latex-generator-grid{grid-template-columns:1fr}.latex-generator-modal,.latex-generator-main-column,.latex-generator-utility-column{justify-content:flex-start}.latex-generator-snippets{grid-template-columns:repeat(3,minmax(0,1fr))}.latex-generator-symbols{grid-template-columns:repeat(4,minmax(0,1fr))}.latex-generator-guide-row{grid-template-columns:1fr}}@media(max-width:780px){.latex-generator-top-grid,.latex-generator-builder-grid,.latex-generator-grid{grid-template-columns:1fr}.latex-generator-meta-row,.latex-generator-section-head,.latex-generator-inline-section{flex-direction:column;align-items:stretch}.latex-generator-inline-section .bd-slider-wrap{max-width:none}.latex-generator-builder-header,.latex-generator-builder-mode-row{flex-wrap:wrap}}/*!css*/`;
const MIRROR_CSS = `
...
.latex-generator-editor-shell .latex-generator-textarea:hover:not(:focus),
.latex-generator-editor-shell .latex-generator-textarea:focus {
...
.latex-generator-token {
  border-radius: 4px;
}

.latex-generator-token--command {
  color: var(--latex-token-command, #7cc7ff);
}

.latex-generator-token--brace {
  color: var(--latex-token-brace, #ffd166);
}

.latex-generator-token--number {
  color: var(--latex-token-number, #9be370);
}

.latex-generator-token--operator {
  color: var(--latex-token-operator, #ff8fab);
}

.latex-generator-token--comment {
  color: var(--latex-token-comment, var(--text-muted));
  font-style: italic;
}

.latex-generator-recent-browser {
  max-height: 62vh;
  overflow: auto;
  padding-right: 6px;
}

.latex-generator-recent-browser .latex-generator-recent-list {
  gap: 8px;
}

.latex-generator-recent-browser .latex-generator-recent-item {
  grid-template-columns: minmax(0, 1fr) auto;
}

.latex-generator-recent-browser .latex-generator-recent-btn {
  min-height: 68px;
  padding: 10px 12px;
  font-size: 12px;
  display: block;
...
.latex-generator-library-save {
  display: flex;
  flex-direction: column;
  gap: 12px;
}

.latex-generator-library-save-header {
  display: flex;
  flex-direction: column;
  gap: 4px;
  padding: 2px 0;
...
.latex-generator-tools-span {
  grid-column: 1 / -1;
}

.latex-generator-library-entry-name {
...
.latex-generator-library-entry-preview {
...
.latex-generator-recent-browser .latex-generator-library-entry-preview {
  max-height: 4.4em;
  overflow: hidden;
}

.latex-generator-tools-grid .latex-generator-panel,
.latex-generator-tools-grid .latex-generator-inline-section {
  height: 100%;
}

.latex-generator-tools-grid .latex-generator-panel-title {
  margin-bottom: 8px;
}
...
.latex-generator-editor-shell:focus-within::after {
  opacity: 1;
}
`;
class SettingsManager {
  ...
  static ensureLibraryStorage() {
    fs.mkdirSync(PLUGIN_STORAGE_DIR, { recursive: true });
  ...
  static saveLibraryEntry(name, latex) {
    ...
    const nextEntries = [
      { name: trimmedName, latex: trimmedLatex },
...
class UIManager {
  ...
  static formatLatexSource(latex) {
    ...
    const flushBuffer = () => {
      ...
      if (value) {
        tokens.push({ type: "text", value, depth });
      }
      buffer = "";
    };
    for (let index = 0; index < formatted.length; index += 1) {
      ...
      if (char === "\\") {
        if (next === "\\") {
          flushBuffer();
          tokens.push({ type: "break", value: "\\\\", depth });
          index += 1;
          continue;
        }
        buffer += char;
      ...
      if ((char === "+" || char === "-" || char === "=") && depth <= 1) {
        flushBuffer();
        tokens.push({ type: "operator", value: char, depth });
        continue;
      }
      if (char === "\n") {
        flushBuffer();
  ...
  static openRecentFormulasModal({ recent, onSelect, onDelete }) {
    UI.showConfirmationModal(
      "Recent Formulas",
  ...
  static SaveLibraryContent({ stateRef, latex }) {
  ...
  static openSaveLibraryModal({ latex, onSave }) {
    if (!latex.trim()) {
      this.toast("No LaTeX source to save.", TOAST_TYPES.ERROR);
      return;
    }
    const stateRef = { current: this.createLibraryName(latex) };
    let didSaveOnce = false;
    UI.showConfirmationModal(
      "Save To Library",
      createElement(UIManager.SaveLibraryContent, { stateRef, latex }),
      {
        confirmText: "Save",
        cancelText: "Cancel",
        size: "bd-modal-large",
  ...
  static openLibraryModal({ entries, onSelect, onDelete }) {
    UI.showConfirmationModal(
      "Equation Library",
  ...
  static LatexModalContent({ stateRef }) {
    ...
    const updateRgbChannel = (channel, value) => {
      ...
      setRgb((current) => ({ ...current, [channel]: nextValue }));
    };
      ...
      createElement(
        ...
        createElement("pre", {
          ...
          dangerouslySetInnerHTML: {
            __html:
              UIManager.highlightLatex(latex) ||
              " ",
          },
        }),
        createElement("textarea", {
          ...
          value: latex,
          placeholder:
            "e.g. E = mc^2 or {\\color[RGB]{255,0,0}x}+{\\color[RGB]{0,180,255}y}",
          autoFocus: true,
          spellCheck: false,
    ...
    const dpiPanel = createElement(
      ...
      {
        className:
          "latex-generator-inline-section latex-generator-size-section latex-generator-panel",
      },
    ...
    return createElement(
      ...
      createElement(
        ...
        createElement("div", { className: "latex-generator-panel-divider" }),
        toolsSection,
      ),
    );
  }
...
class ChatBarManager {
  static getButtonsGroup() {
    const candidates = [
      Webpack.getBySource("showAllButtons", "promotionsByType"),
      Webpack.getBySource("showAllButtons", "paymentsBlocked"),
      Webpack.getBySource("showAllButtons", "channelAppLauncher"),
    ].filter(Boolean);
    for (const candidate of candidates) {
      const buttonGroup = [
        ...
        candidate?.default,
        candidate,
      ].find((entry) => typeof entry?.type === "function");
      if (buttonGroup) {
        return buttonGroup;
      }
    }
  ...
  static getChatBarType(props) {
    return props?.type?.analyticsName ?? props?.type;
  }
  static injectButton(componentProps) {
    if (!componentProps) {
      return false;
    }
    const button = createElement(UIManager.ChatBarButton, {
      key: "latex-generator-button",
    });
    const children = componentProps.children;
    if (Array.isArray(children)) {
      if (!children.some((child) => child?.key === "latex-generator-button")) {
        children.unshift(button);
      }
      return true;
    }
    if (children != null) {
      componentProps.children = [button, children];
      return true;
    }
  ...
  static patch() {
    const ChatBarButtons = ChatBarManager.getButtonsGroup();
    if (!ChatBarButtons) {
      UIManager.toast(
    ...
    Patcher.after(Plugin.PATCH_ID, ChatBarButtons, "type", (_, args, res) => {
      if (
        args.length !== 2 ||
        args[0]?.disabled ||
        !CHAT_BAR_TYPES.includes(ChatBarManager.getChatBarType(args[0])) ||
        !res?.props
      ) {
        return;
      }
      ChatBarManager.injectButton(res.props);
    });
  }
  static unpatch() {
